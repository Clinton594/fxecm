...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #f5f6fa;">
  <center style="width: 100%; background-color: #f5f6fa;">
    <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#f5f6fa">
      <tr>
        <td style="padding: 40px 0;background-color: white;">
          <div style="background-color:white; padding:40px; max-width:670px">
                  ...
                  <td>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tbody>
                        ...
                        <tr>
                          <td style="width: 100%;padding:20px 0 0 0;line-height:26px;color:#666">If this activity is not your own operation, please contact our official customer representative by the following link: <a style="color:#e9b434" href="<?= $post->website ?>contact" target="_blank"><?= $post->website ?>contact</td>
                        </tr>
                        <tr>
