                    ...
                    <li>
                        <div class="uk-container">
                            <div class="uk-grid-medium" data-uk-grid>
                                ...
                                <div class="uk-width-1-2@s">
                                    <img class="in-slide-img" src="assets/img/in-lazy.gif" data-src="assets/img/in-liquid-slide-1.svg" alt="image-slide" width="500" height="400" data-uk-img>
                                </div>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="uk-container">
                            <div class="uk-grid-medium" data-uk-grid>
                                ...
                                <div class="uk-width-1-2@s">
                                    <img class="in-slide-img" src="assets/img/in-lazy.gif" data-src="assets/img/in-liquid-slide-2.svg" alt="image-slide" width="500" height="400" data-uk-img>
                                </div>
                            </div>
                        </div>
                    </li>
                ...
                <div class="uk-section uk-padding-remove-vertical in-slideshow-features uk-visible@m">
                    <div class="uk-container">
                        <ul class="uk-grid uk-child-width-1-5@m uk-text-center" data-uk-grid>
                            <li>
                                <img src="assets/img/in-lazy.gif" data-src="assets/img/in-liquid-ticker-1.svg" alt="ticker-image" data-width data-height data-uk-img>
                                <span class="uk-label uk-label-success uk-margin-left"><i class="fas fa-caret-up"></i>1,740.05</span>
                            </li>
                            <li>
                                <img src="assets/img/in-lazy.gif" data-src="assets/img/in-liquid-ticker-2.svg" alt="ticker-image" data-width data-height data-uk-img>
                                <span class="uk-label uk-label-success uk-margin-left"><i class="fas fa-caret-up"></i>217.90</span>
                            </li>
                            <li>
                                <img src="assets/img/in-lazy.gif" data-src="assets/img/in-liquid-ticker-3.svg" alt="ticker-image" data-width data-height data-uk-img>
                                <span class="uk-label uk-label-danger uk-margin-left"><i class="fas fa-caret-down"></i>270.97</span>
                            </li>
                            <li>
                                <img src="assets/img/in-lazy.gif" data-src="assets/img/in-liquid-ticker-4.svg" alt="ticker-image" data-width data-height data-uk-img>
                                <span class="uk-label uk-label-success uk-margin-left"><i class="fas fa-caret-up"></i>3,218.51</span>
                            </li>
                            <li>
                                <img src="assets/img/in-lazy.gif" data-src="assets/img/in-liquid-ticker-5.svg" alt="ticker-image" data-width data-height data-uk-img>
            ...
            <div class="uk-container uk-light">
                ...
                <div class="uk-child-width-1-3@m" data-uk-grid>
                    <div>
                        <div class="uk-card uk-card-secondary uk-border-rounded uk-cover-container">
                            <div class="uk-card-media-top">
                                <img src="assets/img/in-lazy.gif" data-src="assets/img/in-liquid-object-1.svg" alt="sample-image" data-width data-height data-uk-img>
                            </div>
                    ...
                    <div>
                        <div class="uk-card uk-card-secondary uk-border-rounded uk-cover-container">
                            <div class="uk-card-media-top">
                                <img src="assets/img/in-lazy.gif" data-src="assets/img/in-liquid-object-2.svg" alt="sample-image" data-width data-height data-uk-img>
                            </div>
                            <div class="uk-card-body">
                    ...
                    <div>
                        <div class="uk-card uk-card-secondary uk-border-rounded uk-cover-container">
                            <div class="uk-card-media-top">
                                <img src="assets/img/in-lazy.gif" data-src="assets/img/in-liquid-object-3.svg" alt="sample-image" data-width data-height data-uk-img>
                            </div>
                            <div class="uk-card-body">
                ...
                <div class="uk-grid-large uk-child-width-1-2@m" data-uk-grid>
                    <div class="uk-flex uk-flex-left">
                        <div class="uk-margin-right">
                            <img src="assets/img/in-lazy.gif" data-src="assets/img/in-liquid-icon-1.svg" alt="sample-icon" width="128" height="128" data-uk-img>
                        </div>
                        <div>
                    ...
                    <div class="uk-flex uk-flex-left">
                        <div class="uk-margin-right">
                            <img src="assets/img/in-lazy.gif" data-src="assets/img/in-liquid-icon-2.svg" alt="sample-icon" width="128" height="128" data-uk-img>
                        </div>
                        <div>
                    ...
                    <div class="uk-flex uk-flex-left">
                        <div class="uk-margin-right">
                            <img src="assets/img/in-lazy.gif" data-src="assets/img/in-liquid-icon-3.svg" alt="sample-icon" width="128" height="128" data-uk-img>
                        </div>
                        <div>
                    ...
                    <div class="uk-flex uk-flex-left">
                        <div class="uk-margin-right">
                            <img src="assets/img/in-lazy.gif" data-src="assets/img/in-liquid-icon-4.svg" alt="sample-icon" width="128" height="128" data-uk-img>
                        </div>
                        <div>
                    ...
                    <div class="uk-width-5-6@m uk-inline">
                        <div class="uk-grid-large uk-flex uk-flex-middle uk-flex-right" data-uk-grid>
                            <div class="uk-position-top-left">
                                <img src="assets/img/in-lazy.gif" data-src="assets/img/in-liquid-3-mockup.png" alt="sample-images" width="650" height="469" data-uk-img>
                            </div>
                            <div class="uk-width-1-2@m">
                ...
                <div class="uk-grid uk-flex uk-flex-center">
                    <div class="uk-width-5-6@m">
                        ...
                        <div class="uk-grid-collapse uk-child-width-1-2@s uk-child-width-1-6@m uk-text-center uk-margin-medium in-client-logo-6" data-uk-grid>
                            <div class="uk-tile">
                                <img class="uk-margin-remove" src="assets/img/in-lazy.gif" data-src="assets/img/in-liquid-payment-1.svg" alt="payment-image" width="167" height="55" data-uk-img>
                            </div>
                            <div class="uk-tile">
                                <img class="uk-margin-remove" src="assets/img/in-lazy.gif" data-src="assets/img/in-liquid-payment-2.svg" alt="payment-image" width="167" height="55" data-uk-img>
                            </div>
                            <div class="uk-tile">
                                <img class="uk-margin-remove" src="assets/img/in-lazy.gif" data-src="assets/img/in-liquid-payment-3.svg" alt="payment-image" width="167" height="55" data-uk-img>
                            </div>
                            <div class="uk-tile">
                                <img class="uk-margin-remove" src="assets/img/in-lazy.gif" data-src="assets/img/in-liquid-payment-4.svg" alt="payment-image" width="167" height="55" data-uk-img>
                            </div>
                            <div class="uk-tile">
                                <img class="uk-margin-remove" src="assets/img/in-lazy.gif" data-src="assets/img/in-liquid-payment-5.svg" alt="payment-image" width="167" height="55" data-uk-img>
                            </div>
                            <div class="uk-tile">
                                <img class="uk-margin-remove" src="assets/img/in-lazy.gif" data-src="assets/img/in-liquid-payment-6.svg" alt="payment-image" width="167" height="55" data-uk-img>
                            </div>
                        </div>
